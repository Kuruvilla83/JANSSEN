...
'calendar.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,'Calendar', 'width=200,height='+(this.time_comp ? 215 : 190)+
...
function cal_gen_date2 (dt_datetime) {
	...
	return (  (dt_datetime.getMonth() < 9 ? '0' : '') + (dt_datetime.getMonth() + 1) 
...
function cal_gen_time2 (dt_datetime) {
	...
	return ((dt_datetime.getHours() < 10 ? '0' : '') + dt_datetime.getHours() + ":"	+ (dt_datetime.getMinutes() < 10 ? '0' : '') + (dt_datetime.getMinutes()) + ":"
